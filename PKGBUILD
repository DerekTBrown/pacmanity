...
package() {
  ...
  cp $srcdir/src/pacmanity.sh $pkgdir/usr/lib/pacmanity/pacmanity.sh
  chmod +x $pkgdir/usr/lib/pacmanity/pacmanity.sh
  cp $srcdir/src/pacmanity_aur.sh $pkgdir/usr/lib/pacmanity/pacmanity_aur.sh
  chmod +x $pkgdir/usr/lib/pacmanity/pacmanity_aur.sh

  # Install Hook
  mkdir -p $pkgdir/usr/share/libalpm/hooks
  cp $srcdir/src/pacmanity.hook $pkgdir/usr/share/libalpm/hooks/pacmanity.hook
  cp $srcdir/src/pacmanity_aur.hook $pkgdir/usr/share/libalpm/hooks/pacmanity_aur.hook
